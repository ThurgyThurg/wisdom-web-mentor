...
import { Play, CheckCircle, Clock, Target, ChevronDown, ChevronUp } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="icon" className="text-green-400 hover:text-green-300 hover:bg-gray-800 rounded-full">
